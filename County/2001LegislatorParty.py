# -*- coding: utf-8 -*-
"""
2001 年第五屆立法委員選舉（政黨比例代表）—— 鄉鎮市區得票率地圖（政黨數多之專門方案）

政黨多（6 個政黨會領先鄉鎮），故推出專門處理版本，與總統選舉（4~5 人）不同：
    - 全政黨色階統一由「35% 以下」下修為「25% 以下」起跳（-10 基準）
    - 台灣團結聯盟採用專用 8 色色階（青/紅均不用，改咖啡色系）
    - 政黨名稱過長（>6 字）自動縮小字級並換行
    - 畫布寬度隨圖例（含名稱）自然展開，不鎖定 5071px
...
政黨數多，畫布寬度隨圖例自然展開（不鎖 5071px）。

執行：
    py 2001LegislatorParty.py
"""
import os
import re
import warnings
...
# ===================== 色階（25% 起，5% 間距；較總統選舉之 35% 基準下修 10） =====================
RATE_COLOR_STOPS = [
    [   # 第 1 组：中国国民党（藍色系）
        (25, "#D9F6FF"), (30, "#A6E9FF"), (35, "#73D9FF"), (40, "#40C8FF"),
        (45, "#00C0F4"), (50, "#00A2E8"), (55, "#0080B8"), (60, "#006591"),
        (65, "#004B6B"), (70, "#003247"), (75, "#001F2E"), (100, "#010D29"),
    ],
    [   # 第 2 组：親民黨 —— 橘色系
        (25, "#FFE8D6"), (30, "#FFC2AA"), (35, "#FFA380"), (40, "#FF8456"),
        (45, "#FF662B"), (50, "#FF4701"), (55, "#D93A00"), (60, "#B33000"),
        (65, "#8D2500"), (70, "#6B1D00"), (75, "#4D1400"), (100, "#2E0B00"),
    ],
    [   # 第 3 组：民主进步党（綠色系）
        (25, "#E8FFE0"), (30, "#CEFFC2"), (35, "#C0FFB1"), (40, "#A4FF90"),
        (45, "#78FF4F"), (50, "#68DE45"), (55, "#54B337"), (60, "#3C8027"),
        (65, "#2B5C1C"), (70, "#1D3D13"), (75, "#0F210A"), (100, "#071A09"),
    ],
    [   # 第 4 组：台灣團結聯盟 —— 專用 8 色咖啡色系
        (25, "#F5E9DB"), (30, "#EDDAC0"), (35, "#E8CFAF"), (40, "#E0C199"),
        (45, "#D8AE7B"), (50, "#CB9450"), (55, "#A37135"), (100, "#59401E"),
    ],
    [   # 第 5 组：新党（黄色系）
        (0, "#FFFFEB"), (25, "#FFFFEB"), (30, "#FFF8CC"), (35, "#FFF0A8"),
        (40, "#FFE780"), (45, "#FFDD55"), (50, "#FFF200"), (55, "#E6DA00"),
        (60, "#BFB500"), (65, "#999100"), (70, "#736D00"), (75, "#4D4900"),
        (100, "#383502"),
    ],
    [   # 第 6 组：無黨籍及未經政黨推薦（灰色系）
        (25, "#F0F0F0"), (30, "#E2E2E2"), (35, "#D4D4D4"), (40, "#C6C6C6"),
        (45, "#B8B8B8"), (50, "#A3A3A3"), (55, "#8E8E8E"), (60, "#7A7A7A"),
        (65, "#666666"), (70, "#525252"), (75, "#3D3D3D"), (100, "#292929"),
    ],
]
